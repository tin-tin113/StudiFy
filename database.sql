...
-- Group Tasks (assigned within a group)
...
-- Group Messages (multi-person chat)
...
-- Group Message Read Tracking (per-user per-message)
CREATE TABLE IF NOT EXISTS group_message_reads (
    group_id INT NOT NULL,
    user_id INT NOT NULL,
    last_read_id INT NOT NULL DEFAULT 0 COMMENT 'ID of last message read by this user',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
-- Group Join Requests (for approval mode)
...
-- ============================================
-- Migration queries for v6.0 (Study Groups):
-- ============================================
-- CREATE TABLE IF NOT EXISTS study_groups (...);
-- CREATE TABLE IF NOT EXISTS group_members (...);
-- CREATE TABLE IF NOT EXISTS group_tasks (...);
